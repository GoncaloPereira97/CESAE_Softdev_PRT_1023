...
public abstract class Veiculo {
    ...
    public Veiculo(String marca, String modelo, int anoFabricro, int potencia, TipoCombustivel tipoCombustivel, int cilindrada, double litros100km) {
        this.marca = marca;
        this.modelo = modelo;
    ...
    public Veiculo corrida(Veiculo carro) {
